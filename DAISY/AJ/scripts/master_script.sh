...
# Generating phylogeny for each static barcode
# for fasta_file in "${intermediate_dir}"/*_merged_homdomain_10x_barcode_combined.fasta; do
#   echo "Processing phylogeny for file: ${fasta_file%_merged_homdomain_10x_barcode_combined.fasta}"
#   sample_dir="${fasta_file%_merged_homdomain_10x_barcode_combined.fasta}"
#   echo "Sample directory: $sample_dir"
#   for BC in "$sample_dir"/BC*.txt; do
#     if [ -e "$BC" ]; then
...
#     else
#       echo "No BC files found in: $sample_dir"
#     fi
#   done
# done
