...
for fasta_file in "${intermediate_dir}"/*merged_homdomain_10x_barcode_combined.fasta; do
    ...
    # Selecting the 10x barcode, Static and Mutable barcode
    ...
    # Selecting the maximum 10x barcode, Static Barcode, and Mutable Barcode
...
echo "Conversion to newick and nexus is completed"

# Generating the tree phylogeny
# iqtree2 parameters 
...
# Combine ModelFinder, tree search, ultrafast bootstrap and SH-aLRT test:
...
# for nexus_file in "${intermediate_dir}/*.nexus"; do
#   iqtree2 -s $nexus_file --alrt 1000 -B 1000 -T AUTO
# done
